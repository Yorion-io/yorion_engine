...
# Create pubspec.yaml template (Required for codegen)
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    echo "Checking for macOS/iOS targets..."
    rustup target add x86_64-apple-darwin aarch64-apple-darwin aarch64-apple-ios aarch64-apple-ios-sim
...
echo "Checking for Android targets..."
